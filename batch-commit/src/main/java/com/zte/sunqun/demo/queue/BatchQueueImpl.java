...
public class BatchQueueImpl<T> implements BatchQueue<T> {
    ...
    public BatchQueueImpl(String name, int batchSize, int timeoutInMs, Consumer<List> consumer) {
        this.batchSize = batchSize;
        this.timeoutInMs = timeoutInMs;
        this.consumer = consumer;
    }

    public BatchQueueImpl(int batchSize, Consumer<List> consumer) {
...
//                }
    ...
    private void drainToConsume() {
        ...
        System.out.println("queue size:" + queue.size() + " and batch size=" + batchSize);
