...
import com.zte.sdn.oscp.yang.gen.v1.ip.device.rev20160524.device.SystemImpl;
...
public class DeviceImpl implements Device {
    ...
    //attribute.txt
    @Relation(parentFieldNames = {"id"}, childFieldNames = {"parentId"}, memberType = SystemImpl.class)
    private System system = new SystemImpl();
