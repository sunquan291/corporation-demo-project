...
import com.zte.sdn.oscp.yang.gen.v1.urn.zte.ngip.ipsdn.device.manager.rev20150915.ipsdndevicemanager.getdevices.getdevicesoutput.deviceinfo.NetconfConnectionImpl;
...
import com.zte.sdn.oscp.yang.gen.v1.urn.zte.ngip.ipsdn.device.manager.rev20150915.ipsdndevicemanager.getdevices.getdevicesoutput.deviceinfo.RestconfConnectionImpl;
...
import com.zte.sdn.oscp.yang.gen.v1.urn.zte.ngip.ipsdn.device.manager.rev20150915.ipsdndevicemanager.getdevices.getdevicesoutput.deviceinfo.ParentImpl;
...
import com.zte.sdn.oscp.yang.gen.v1.urn.zte.ngip.ipsdn.device.manager.rev20150915.ipsdndevicemanager.getdevices.getdevicesoutput.deviceinfo.CliConnectionImpl;
...
import com.zte.sdn.oscp.yang.gen.v1.urn.zte.ngip.ipsdn.device.manager.rev20150915.ipsdndevicemanager.getdevices.getdevicesoutput.deviceinfo.NniImpl;
...
import com.zte.sdn.oscp.yang.gen.v1.urn.zte.ngip.ipsdn.device.manager.rev20150915.ipsdndevicemanager.getdevices.getdevicesoutput.deviceinfo.SnmpConnectionImpl;
...
import com.zte.sdn.oscp.yang.gen.v1.urn.zte.ngip.ipsdn.device.manager.rev20150915.ipsdndevicemanager.getdevices.getdevicesoutput.deviceinfo.BgpConnectionImpl;
import com.zte.sdn.oscp.yang.gen.v1.urn.zte.ngip.ipsdn.device.manager.rev20150915.ipsdndevicemanager.getdevices.getdevicesoutput.deviceinfo.PcepConnectionImpl;
...
public class DeviceInfoImpl implements DeviceInfo {
    ...
    */
    ...
    @Relation(parentFieldNames = {"id"}, childFieldNames = {"parentId"}, memberType = ParentImpl.class)
    private Parent parent = new ParentImpl();
